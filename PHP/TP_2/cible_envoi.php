    ...
    if(isset($_FILES['config'])) {
        if($_FILES['config']['size'] <= 10000) {
            ...
            or $_FILES['config']['type'] == 'text/xml'){
                ...
                move_uploaded_file($_FILES['config']['tmp_name'], 'upload/'.
...
//var_dump($Tab_display); 
//var_dump($Tab_display->nodes[0]-> interfaces[0]->addresses[0]); 
//echo $Tab_display->nodes[0]-> interfaces[0]->addresses[0]->address; 
//echo $Tab_display->nodes[0]-> interfaces[0]->addresses[0]->proto;
?>